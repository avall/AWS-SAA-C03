...
### Route tables
- These routes define paths between all the subnets (public & private) of the VPC. 

| Public Subnet     |            | This route table is used for all 3 public subnets (1a, 1b, 1c)                                                                                                                                                                                                                                     |
|-------------------|------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Destination**   | **Target** | **Description**                                                                                                                                                                                                                                                                                    |
...
![Bastion Host](../uml/004-vpc/bastion-host.svg)
