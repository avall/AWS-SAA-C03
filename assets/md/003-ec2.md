...
## 1.3 EC2 InstanceTypes - Overview
...
## 1.6 EC2 Instances Purchasing Options
![](../uml/003-ec2/ec2-purchase-options.svg)

## 1.7 EC2 Spot Instances lifecycle
...
## 1.12 Elastic Network Interface (ENI)
