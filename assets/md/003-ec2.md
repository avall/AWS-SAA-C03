...
- **io1 / io2** (IOPS provisioned): can increase IO independently. Can be boot volume. Support multiattach (same EBS attached to multi EC2 (up to 16) in the same AvZone).
...
- The storage capacity of instance store volumes is fixed
